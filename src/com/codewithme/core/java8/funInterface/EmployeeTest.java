...
public class EmployeeTest {
    ...
    public static List<Employee> getEmployeeList(){
        ...
        Employee e3=new Employee(103,"sworav","hydrabad","530092","8003042434","IT",79);
        ...
        Employee e6=new Employee(106,"rocky","hydrabad","530065","8003042472","ECE",90);

        Employee e7=new Employee(107,"roshan","vizag","532000","8003043422","IT",85);

        Employee e8=new Employee(107,"satish","hydrabad","530090","8003012422","CSE",92);
